...
newli1.querySelector(".php").setAttribute('src', '../images/home/web-programming.png');
newli2.querySelector(".php").setAttribute('src', '../images/home/code.png');
newli3.querySelector(".php").setAttribute('src', '../images/home/mysql.png');
newli4.querySelector(".php").setAttribute('src', '../images/home/lightbulb.png');
